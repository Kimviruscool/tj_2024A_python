...
#constatnt() 값 변경 불가능 , Variable() 값 변경 가능

#3. 텐서플로 변수 속성 확인
print(tensor_var1.name) #Variable:0 변수명
print(tensor_var1.shape) #(2,3) 크기
print(tensor_var1.dtype) #<dtype: 'int32'> 데이터 자료형/타입
print(tensor_var1.numpy()) #[[0 1 2] [3 4 5]] 데이터

#4. 텐서플로 변수 데이터/변경/수정/새로운 할당 / 자료형 과 크기 동일 해야 한다. #객체 타입
